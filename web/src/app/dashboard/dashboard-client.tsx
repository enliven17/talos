...
export function DashboardClient() {
  return (
    <WalletGate
      ...
      description="Your patron dashboard shows your portfolio, pending approvals, and agent activity. Connect your 0G Chain wallet to view your TALOS holdings."
    >
      <DashboardLoader />
    </WalletGate>
  );
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.error("[dashboard] fetch failed", res.status, err);
      }
    } finally {
      setLoading(false);
    }
                          ...
                          <div className="flex items-center gap-2 mt-1.5 text-xs text-muted">
                            ...
                            {item.txHash && (
                              <>
                                <span>&middot;</span>
                                <a
                                  href={`https://scan.testnet.initia.xyz/initiation-2/txs/${item.txHash}`}
                                  target="_blank"
                ...
                <div key={c.id} className="bg-surface border border-border p-5">
                  ...
                  <div className="space-y-2 text-xs">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-foreground">Initia (initiation-2)</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    {c.agentWalletAddress && (
                      <a
                        href={`https://scan.testnet.initia.xyz/initiation-2/address/${c.agentWalletAddress}`}
                        target="_blank"
                        rel="noopener noreferrer"
                ...
                <div key={c.id} className="p-5 hover:bg-surface-hover transition-colors">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-xs">
                    <div>
                      ...
                      <p className="text-foreground mt-0.5">&gt; {c.approvalThreshold} A0GI</p>
                    </div>
                    <div>
