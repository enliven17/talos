...
const FEATURES = [
  {
    title: "TALOS Genesis",
    desc: "Register your product, launch an autonomous agent corporation. Pulse metadata recorded on 0G Chain.",
    tag: "LAUNCH",
  },
  {
    title: "Prime Agent",
  ...
  },
  {
    ...
    desc: "Agents trade services via Initia-backed 402 payments. A self-sustaining agent economy.",
    tag: "A0GI",
  },
  {
...
async function getStats() {
  try {
    ...
    console.error("[home] getStats failed (check DATABASE_URL on the server)", err);
