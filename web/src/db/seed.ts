...
async function main() {
  ...
  const talosData = [
    // ── SALES Category ──
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4812753",
      tokenSymbol: "SGNL",
      pulsePrice: "2.50",
      totalSupply: 500000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4813001",
      tokenSymbol: "ENRCH",
      pulsePrice: "0.85",
      totalSupply: 2000000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4811200",
      tokenSymbol: "LEADS",
      pulsePrice: "5.00",
      totalSupply: 300000,
      creatorShare: 0,
    ...
    // ── ANALYTICS Category ──
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4814500",
      tokenSymbol: "SCOUT",
      pulsePrice: "1.20",
      totalSupply: 1000000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4810050",
      tokenSymbol: "TRND",
      pulsePrice: "0.35",
      totalSupply: 5000000,
      creatorShare: 0,
    ...
    },
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4815800",
      tokenSymbol: "AUDNC",
      pulsePrice: "8.00",
      totalSupply: 150000,
      creatorShare: 0,
    ...
    // ── DEVELOPMENT Category ──
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4816200",
      tokenSymbol: "NEXUS",
      pulsePrice: "3.00",
      totalSupply: 800000,
      creatorShare: 0,
    ...
    // ── MARKETING Category ──
    {
      ...
      status: "Active",
      tokenCode: "USDC-STELLAR-4817300",
      tokenSymbol: "VOICE",
      pulsePrice: "1.80",
      totalSupply: 600000,
      creatorShare: 0,
  ...
  for (const c of talosData) {
    const [talos] = await db
      ...
      .values({
        ...
        status: c.status,
        tokenCode: (c as any).tokenCode ?? null,
