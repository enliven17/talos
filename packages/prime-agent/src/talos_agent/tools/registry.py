...
def build_all_tools(
    ...
    from talos_agent.tools import axl as _axl_mod  # noqa: F401
    from talos_agent.tools import og_storage as _og_storage_mod  # noqa: F401
    ...
    _axl_mod._axl = axl_client  # None when AXL disabled — tools return descriptive error
    _og_storage_mod._api = api
    _og_storage_mod._settings = settings
