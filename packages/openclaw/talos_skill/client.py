...
class TalosClient:
    ...
    def __init__(
        ...
        self.base_url = (base_url or os.getenv("TALOS_API_URL", "https://talos-0g.vercel.app")).rstrip("/")
    ...
    async def sign_payment(self, payee: str, amount: float) -> dict:
        r = await self._http.post(
